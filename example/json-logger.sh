...
# JSON logger service that outputs structured logs
# This demonstrates how pei handles services that already output JSON

count=0
while true; do
    count=$((count + 1))
    
    # Output some structured JSON logs with different levels
